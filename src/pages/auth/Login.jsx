    ...
    return (
        <>
            <div className="main-registerPage-container w-full min-h-screen relative bg-[#FAFBFC]">
                ...
                <div className="trello-left-image w-[25vw] absolute bottom-[2vw] left-[1vw]">
                    <img className='w-full h-full' src="https://id-frontend.prod-east.frontend.public.atl-paas.net/assets/trello-left.4f52d13c.svg" alt="trello-left-image" />
                </div>
                {/* right side trello image */}
                <div className="trello-right-image w-[25vw] absolute bottom-[2vw] right-[1vw]">
                    <img className='w-full h-full' src="https://id-frontend.prod-east.frontend.public.atl-paas.net/assets/trello-right.e6e102c7.svg" alt="trello-left-image" />
                </div>
                <div className="formContainer w-full h-[100dvh] flex justify-center items-center">
                    {/* Inner form container */}
                    <div className="inner-form-container w-[25vw] h-[45vw] shadow-md p-2 bg-white">
                        ...
                        <div className="heading-span-wrapper text-[1.3vw] font-bold w-full flex justify-center">
                        ...
                        <form className='flex flex-col gap-2 mt-3' onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="button-wrapper w-full flex justify-center">
                                <button
                                    className=" text-white bg-blue-400 py-1 rounded-lg w-[15vw] text-[1.3vw]"
                                    type="submit"
                                >
                                    Create Account
                                </button>
