...
function HomePage() {
  ...
  const onSubmitCard = (CardData) => {
    setIsAddCard(false);
    dispatch(
      AddCard({ boardID: boardId, listID: listId, cardname: CardData.cardname })
    );
  };
  ...
  return (
    <>
      ...
      <div className="main-homepage-wrapper w-full min-h-screen flex bg-blue-50 relative">
        ...
        <div className="sidebar-wrapper bg-gradient-to-b from-blue-800 to-blue-900 shadow-lg max-md:w-[25vw] max-sm:w-[30vw]">
          <div className="sidebar w-[18vw] h-[100vh] text-white border-r border-blue-700 max-md:w-full">
        ...
        {boardId !== null ? (
          <div className="tasks-management w-[80vw] bg-white shadow-md max-md:w-full">
