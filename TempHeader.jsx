...
function Header() {
  ...
  const onSubmitList = (data) => {
    if (selectedBoardId) {
      dispatch(
        CreateList({ boardID: selectedBoardId, listname: data.listname })
      );
    ...
    <>
      <div className="main-header-container w-[100vw] h-[5vw] flex justify-between items-center border-[#1F2937] border-b-2 p-5">
        ...
        <div className="operations-wrapper w-[60vw] flex items-center justify-evenly">
          ...
          {/* Boards Dropdown */}
          <div className="boards-dropdown relative" ref={dropdownRef}>
            <div
              className="dropdown-header flex items-center cursor-pointer"
              onClick={() => setIsDropdownOpen(!isDropdownOpen)}
            >
              <span className="mr-2">My Boards</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          {/* List Creation Icon */}
          <div
            className="list-section cursor-pointer"
            onClick={() => {
              if (selectedBoardId) {
      ...
      >
        <div className="modal-content">
          ...
          <form onSubmit={handleSubmit(onSubmitList)} className="space-y-4">
            <div>
              <input
